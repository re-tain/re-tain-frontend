export const TEZOS_NETWORK = import.meta.env.REACT_APP_TEZOS_NETWORK || 'ghostnet';
export const TZKT_API = import.meta.env.REACT_APP_TZKT_API || 'https://api.ghostnet.tzkt.io/';
export const RPC_NODE = import.meta.env.REACT_APP_RPC_NODE || 'https://ghostnet.ecadinfra.com'//'https://ghostnet.tezos.marigold.dev/';
