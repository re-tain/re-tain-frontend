...
function Layout({ children, favicon = "/favicon.png" }) {
  ...
  const linkList = {
    contact: [
      ...
      { name: 'Instagram', href: 'https://www.instagram.com/re_tain_xyz/' },
      { name: 'LinkedIn', href: 'https://www.linkedin.com/company/98404044/' },
      { name: 'Email', href: 'mailto:andre@andrefuchs.xyz' },
    ],
    support: [
      { name: 'Onboarding', href: 'https://blog.re-tain.xyz/artist-onboarding/' },
    ...
    company: [
      ...
      { name: 'Newsletter', href: 'https://creativecoding.substack.com/' },
  ...
  const tzktLink = [
    { name: 'Built with TzKT API', href: 'https://tzkt.io' }
  ]
          ...
          <div className="flex items-center gap-x-6 bg-black px-6 py-2.5 sm:px-3.5 sm:before:flex-1">
            <div className="flex flex-wrap items-center gap-x-4 gap-y-2">
              <p className="text-sm leading-6 text-grey-400">
                <strong className="font-semibold ">Private Testnet Alpha Version 1.0</strong>
                    ...
                    <div className="flex items-center px-2 lg:px-0">
                      ...
                      <div className="hidden lg:ml-6 lg:block">
                        <div className="flex space-x-4">
                          ...
                          <a href="/series-overview" className="rounded-md bg-grey-800 px-3 py-2 text-sm font-medium text-white">
                            Explore
                          </a>
                          <a
                ...
                <Disclosure.Panel className="lg:hidden">
                  <div className="space-y-1 px-2 pb-3 pt-2">
                    ...
                    <Disclosure.Button
                      as="a"
                      href="#"
                      className="block rounded-md bg-grey-900 px-3 py-2 text-base font-medium text-white"
                    >
                      Button 1
                    </Disclosure.Button>
                    <Disclosure.Button
                      as="a"
                      href="#"
                      className="block rounded-md px-3 py-2 text-base font-medium text-grey-300 hover:bg-grey-700 hover:text-white"
                    >
                      Button 2
                    </Disclosure.Button>
                    <Disclosure.Button
                  ...
                  <div className="border-t border-grey-700 pb-3 pt-4">
                    <div className="flex items-center px-5">
                      ...
                      <div className="ml-3">
                        ...
                        <div className="text-sm font-medium text-grey-400">Wallet Address</div>
                      </div>
                    </div>
                    ...
                    <div className="mt-3 space-y-1 px-2">
                      <Disclosure.Button
                        as="a"
                        href="/user/tz29KCrBcS6aJhqwPmHB5Cyh2cccjTs9Lghx"
        ...
        <div className="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-4">
          <div className="mt-10 flex justify-center space-x-10">
            <div className="flex space-x-16 md:order-2 mt-10">
              {linkList.social.map((item) => (
                <a key={item.name} href={item.href} target="_blank" className="text-brand hover:text-grey-400">
          ...
          <div className="mt-16 xl:grid xl:grid-cols-3 xl:gap-8">
            ...
            <div className="mt-16 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
                ...
                <div>
                  ...
                  <ul role="list" className="mt-6 space-y-4">
                    {linkList.contact.map((item) => (
                      <li key={item.name}>
                        <a href={item.href} target="_blank" className="text-sm leading-6 text-grey-300 hover:text-brand">
                          {item.name}
                        </a>
                      </li>
                    ))}
              ...
              <div className="md:grid md:grid-cols-2 md:gap-8">
                <div>
                  <h3 className="text-sm font-semibold leading-6 text-white">Re—tain</h3>
                  <ul role="list" className="mt-6 space-y-4">
          ...
          <div className="mt-16 border-t border-white/10 pt-8 sm:mt-20 lg:mt-24 lg:flex lg:items-center lg:justify-between">
            <div>
              <h3 className="text-sm font-semibold leading-6 text-white">Subscribe to our <span className="text-grey-300"><a href="https://creativecoding.substack.com/" target="_blank">free newsletter</a></span></h3>
          ...
          <div className="mt-8 border-t border-white/10 pt-8 md:flex md:items-center md:justify-between">
            <div className="flex space-x-6 md:order-2">
              ...
              {tzktLink.map((item) => (
                <div key={item.name} className="">
                  <a href={item.href} target="_blank" className="mt-8 text-xs leading-5 text-grey-500 md:order-1 md:mt-">
                    {item.name}
                  </a>
                </div>
              ))}
            ...
            <p className="mt-8 text-xs leading-5 text-grey-200 md:order-1 md:mt-0">
              &copy; 2024 Re—tain: Generative Art Marketplace on Tezos
            </p>
          </div>
        </div>
      </footer>
